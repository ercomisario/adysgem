            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav">
                ...
                <?php if($this->user->role === "admin"){?>
                 ...
                 <?php if($this->user->role === "admin"){?>
                 <li class="dropdown">
                    <a href="#" class="dropdown-toggle flat-box" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-usd"></i> <?=label("Expenses");?> <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                       <li class="flat-box"><a href="<?=base_url()?>expences"><i class="fa fa-usd"></i> <?=label("Expenses");?></a></li>
                       <li class="flat-box"><a href="<?=base_url()?>catalog_expences"><i class="fa fa-archive"></i> <?=label("Catalogo Egresos");?></a></li>                      
